...
VALUES
    ...
    (2, 'Лучшее поле для валюты', 218, 'Какое поле лучше подходит для хранения евро и долларов'),
    ...
    (10, 'Проблема', 33, 'Запрос не работает, постоянно выпадает ошибка Syntax Error.'),
    (11, 'Большая проблема', 289, 'Система подвисла не возвращает ответ.'),
    (12, 'Так можно?', 4814, 'Разве такой синтаксис это не ошибка?');
