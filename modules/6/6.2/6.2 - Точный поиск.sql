...
CREATE TABLE `products` (
    ...
    sizes SET('32','34','36','38','40','42','44','46','48','50','52','M','L','S','XL','XS','2XL','4XL') DEFAULT NULL,

    PRIMARY KEY (`id`),
    FULLTEXT INDEX `name` (`name`)
);

INSERT INTO `products` (id, name, count, price, sizes)
VALUES
...
-- | id | name                 | price |
-- +----+----------------------+-------+
-- | 15 | Джинсы Mango Soho2   | 1999  |
-- | 10 | Джинсы Mango Jane2   | 1999  |
-- | 4  | Джинсы Mango Kim2    | 2499  |
-- | 19 | Джинсы Mango Noa2    | 2499  |
-- | 1  | Джинсы Mango Lonny 2 | 2990  |
-- +----+----------------------+-------+
